...
public class SuccessView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        View view = inflater.inflate(R.layout.success_view, this);
        iv1 = view.findViewById(R.id.gtm_iv_success1);
        iv2 = view.findViewById(R.id.gtm_iv_success2);
        iv3 = view.findViewById(R.id.gtm_iv_success3);
        iv4 = view.findViewById(R.id.gtm_iv_success4);
        iv5 = view.findViewById(R.id.gtm_iv_success5);
        iv6 = view.findViewById(R.id.gtm_iv_success6);
        textView = findViewById(R.id.tv_success_demo);
    }
